...
export default function ElegantTemplate({ form }) {
    ...
    const styles = StyleSheet.create({
        ...
        header: { flexDirection: "row", borderBottomWidth: 1, borderBottomColor: "#E5E7EB" },
        accentStripe: { width: 5, backgroundColor: T },
        headerContent: { flex: 1, padding: "20 20 16", flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start" },
        ...
        title: { fontFamily: "Space Grotesk", fontWeight: 900, fontSize: 28, color: T, letterSpacing: -0.5 },
        titleMeta: { marginTop: 6, alignItems: "flex-end", gap: 2 },
        invoiceNum: { fontSize: 10, fontWeight: 600, color: "#9CA3AF", textTransform: "uppercase", letterSpacing: 0.8 },
        invoiceDate: { fontSize: 10, color: "#9CA3AF" },
        ...
        signatureImage: { maxHeight: 45, maxWidth: 140, marginBottom: 4, alignSelf: "flex-end" },
        signatureLine: { borderTopWidth: 1, borderTopColor: "#374151", paddingTop: 4 },
        signatureLabel: { fontSize: 9, color: "#9CA3AF" }
    });

    return (
        <Document title={`Invoice-${form.invoiceNumber}`}>
            <Page size="A4" style={styles.page}>
                    ...
                    <View style={styles.headerContent}>
                        ...
                        <View style={styles.headerRight}>
                            ...
                            <View style={styles.titleMeta}>
                                <Text style={styles.invoiceNum}>#{form.invoiceNumber}</Text>
                                <Text style={styles.invoiceDate}>Date: {form.invoiceDate}</Text>
                                {form.dueDate && <Text style={styles.invoiceDate}>Due: {form.dueDate}</Text>}
                                {form.poNumber && <Text style={styles.invoiceDate}>PO#: {form.poNumber}</Text>}
                            </View>
                        </View>
                    </View>
                </View>
                ...
                <View style={styles.main}>
                    ...
                    <View style={styles.tableHeader}>
                        ...
                        {form.showHSN && <Text style={[styles.thText, COL.hsn]}>HSN/SAC</Text>}
