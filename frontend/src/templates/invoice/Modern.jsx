...
export default function ModernTemplate({ form }) {
    ...
    const styles = StyleSheet.create({
        ...
        sidebar: { width: 135, backgroundColor: T, padding: "24 14", color: "#ffffff", height: "100%" },
        main: { flex: 1, padding: "24 24" },
        
        sidebarTitle: { fontFamily: "Space Grotesk", fontWeight: 700, fontSize: 15, marginBottom: 4 },
        ...
        <Document title={`Invoice-${form.invoiceNumber}`}>
            <Page size="A4" style={styles.page}>
                <View style={styles.sidebar}>
                    ...
                    <Text style={styles.sidebarNum}>#{form.invoiceNumber}</Text>
                    ...
                    <View style={styles.sidebarFooter}>
                        {(form.dueDate || form.poNumber) && (
                            <View style={{ marginBottom: 16 }}>
                                {form.dueDate && <Text style={{ fontSize: 8, opacity: 0.7, marginBottom: 2 }}>DUE: {form.dueDate}</Text>}
                                {form.poNumber && <Text style={{ fontSize: 8, opacity: 0.7 }}>PO#: {form.poNumber}</Text>}
                            </View>
                        )}
                        <Text style={styles.sidebarLabel}>Amount Due</Text>
                        <Text style={{ fontSize: 11, fontWeight: 700 }}>Rs.{calc.grandTotal}</Text>
                    </View>
                </View>
                ...
                <View style={styles.main}>
                    ...
                    <View style={styles.billSection}>
                        <View style={styles.billCol}>
                            <Text style={styles.billLabel}>Client Details</Text>
