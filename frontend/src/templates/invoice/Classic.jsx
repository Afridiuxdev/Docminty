...
export default function InvoiceTemplate({ form }) {
    ...
    const styles = StyleSheet.create({
        ...
        invoiceNum: { fontSize: 12, color: "rgba(255,255,255,0.85)", marginTop: 4 },
        metaBox: { fontSize: 9, color: "rgba(255,255,255,0.75)", marginTop: 4, lineHeight: 1.4 },
        
        body: { padding: "24 24" },
        billSection: { flexDirection: "row", gap: 24, marginBottom: 20 },
        billCol: { flex: 1 },
        billLabel: { fontSize: 9, color: "#9CA3AF", textTransform: "uppercase", letterSpacing: 1, marginBottom: 6, fontFamily: "Space Grotesk", fontWeight: 700 },
                ...
                <View style={styles.header}>
                    ...
                    <View style={styles.headerRight}>
                        ...
                        <View style={styles.metaBox}>
                            <Text>Date: {form.invoiceDate}</Text>
                            {form.dueDate && <Text>Due: {form.dueDate}</Text>}
                        ...
                        <View style={styles.totalsBox}>
                            ...
                            {parseFloat(calc.totalDiscount) > 0 && (
                                <View style={styles.totalRow}>
                                    ...
                                    <Text style={[styles.totalValue, { color: "#EF4444" }]}>-Rs.{calc.totalDiscount}</Text>
                                </View>
                            )}
