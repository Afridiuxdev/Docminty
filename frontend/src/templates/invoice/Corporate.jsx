...
export default function CorporateTemplate({ form }) {
    ...
    const styles = StyleSheet.create({
        ...
        header: { textAlign: "center", padding: "20 24 16", borderBottomWidth: 2, borderBottomColor: T },
        ...
        fromDetails: { fontSize: 9, color: "#6B7280", lineHeight: 1.5, maxWidth: 500, alignSelf: "center", textAlign: "center" },
        metaRow: { flexDirection: "row", justifyContent: "center", gap: 16, marginTop: 8 },
        metaItem: { fontSize: 9, fontWeight: 700, color: "#9CA3AF", textTransform: "uppercase", letterSpacing: 0.4 },
        secondaryMeta: { flexDirection: "row", justifyContent: "center", gap: 16, marginTop: 4, fontSize: 9, color: "#9CA3AF" },
            ...
            <Page size="A4" style={styles.page}>
                <View style={styles.header}>
                    ...
                    <View style={styles.metaRow}>
                        ...
                        <Text style={styles.metaItem}>INV: #{form.invoiceNumber}</Text>
                        <Text style={styles.metaItem}>DATE: {form.invoiceDate}</Text>
                    </View>
                    {(form.dueDate || form.poNumber) && (
                        <View style={styles.secondaryMeta}>
                            {form.dueDate && <Text>DUE BY: {form.dueDate}</Text>}
                            {form.poNumber && <Text>PO#: {form.poNumber}</Text>}
                        </View>
                    )}
                </View>
