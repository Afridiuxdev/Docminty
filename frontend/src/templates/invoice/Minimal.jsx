...
export default function MinimalTemplate({ form }) {
    ...
    const styles = StyleSheet.create({
        page: { fontFamily: "Inter", fontSize: 10, color: "#111827", padding: 24, backgroundColor: "#ffffff" },
        ...
        invoiceMeta: { fontSize: 9, color: "#9CA3AF", marginTop: 4 },
        ...
        notesSection: { flexDirection: "row", gap: 16, marginTop: 24 },
        notesBox: { flex: 1 },
            ...
            <Page size="A4" style={styles.page}>
                <View style={styles.header}>
                    <View style={styles.headerLeft}>
                        ...
                        {form.fromGSTIN && <Text style={[styles.fromDetails, { marginBottom: 1 }]}>GSTIN: {form.fromGSTIN}</Text>}
