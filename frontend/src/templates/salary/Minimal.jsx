...
export default function MinimalTemplate({ form }) {
    ...
    const styles = StyleSheet.create({
        ...
        header: { padding: "20 24 16", borderBottomWidth: 1, borderBottomColor: "#E5E7EB" },
        headerTop: { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start" },
        logo: { height: 40, objectFit: "contain", marginBottom: 6 },
        companyName: { fontFamily: "Space Grotesk", fontWeight: 700, fontSize: 15, color: "#111827" },
        companyDetails: { fontSize: 9, color: "#9CA3AF", marginTop: 2, lineHeight: 1.4 },
        titleBox: { textAlign: "right" },
        title: { fontFamily: "Space Grotesk", fontWeight: 800, fontSize: 18, color: "#111827" },
        period: { fontSize: 11, color: "#9CA3AF", marginTop: 4 },
        accentLine: { height: 2, backgroundColor: T, marginTop: 12, borderRadius: 1 },
        ...
        mgrName: { fontSize: 10, fontWeight: 700 },
        mgrLabel: { fontSize: 8, color: "#9CA3AF" }
    });
            ...
            <Page size="A4" style={styles.page}>
                <View style={styles.header}>
                    <View style={styles.headerTop}>
                        <View>
                            ...
                            <Text style={styles.companyDetails}>Ph: {form.companyPhone}{form.companyEmail ? ` | ${form.companyEmail}` : ""}</Text>
                        </View>
                ...
                <View style={styles.main}>
                    ...
                    <View style={styles.netPayBox}>
                        ...
                        <View>
                            <Text style={[styles.label, { color: "rgba(255,255,255,0.7)", textAlign: "right" }]}>Amount in Words</Text>
