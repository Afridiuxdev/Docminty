...
const styles = StyleSheet.create({
    ...
    empLabel: { fontSize: 8, color: "#9CA3AF", textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 2, fontFamily: "Space Grotesk" },
    empValue: { fontSize: 10, fontWeight: 700, color: "#111827", fontFamily: "Space Grotesk" },
    ...
    sectionHT: { fontSize: 9, fontWeight: 700, color: "#ffffff", textTransform: "uppercase", letterSpacing: 1, fontFamily: "Space Grotesk" },
    tRow: { flexDirection: "row", justifyContent: "space-between", padding: "5 10", borderBottomWidth: 1, borderBottomColor: "#F3F4F6" },
    rowLabel: { fontSize: 9, color: "#374151", fontFamily: "Space Grotesk" },
    rowValue: { fontSize: 9, fontWeight: 700, color: "#111827", fontFamily: "Space Grotesk" },
    ...
    mgrName: { fontSize: 10, fontWeight: 700, color: "#111827", fontFamily: "Space Grotesk" }
});
