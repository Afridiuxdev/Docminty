            ...
            <Page size="A4" style={styles.page}>
                ...
                <View style={{ marginBottom: 12 }}>
                    <View style={styles.tableHeader}>
                        <View style={{ flex: 0.3 }}><Text style={styles.thText}>#</Text></View>
                        ...
                        <View style={{ flex: 0.8 }}><Text style={[styles.thText, { textAlign: "right" }]}>Amount</Text></View>
                    </View>
                    {calc.items.map((item, i) => (
                        <View key={i} style={styles.tableRow}>
                            <View style={{ flex: 0.3 }}><Text style={styles.tdText}>{i + 1}</Text></View>
                            ...
                            <View style={{ flex: 0.8 }}><Text style={[styles.tdText, { textAlign: "right", fontFamily: "Helvetica-Bold" }]}>{"Rs. " + item.amount}</Text></View>
                        </View>
                    ))}
                </View>
