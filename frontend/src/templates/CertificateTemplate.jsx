...
const styles = StyleSheet.create({
    ...
    outerBorder: { margin: 20, border: "8pt solid #F0F4F3", padding: 0, position: "relative" },
    ...
    sigLine: { borderTopWidth: 1.5, borderTopColor: "#374151", width: 120, paddingTop: 5, marginTop: 20 },
