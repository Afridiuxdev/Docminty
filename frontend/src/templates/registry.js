...
export const TEMPLATE_REGISTRY = {
  ...
  certificate: {
    ...
    Corporate: { name: "Corporate", pro: true,  description: "Formal corporate certificate style",       accent: "#1E3A5F", preview: "corporate" },
  ...
  rent: {
    Classic: { name: "Classic", pro: false, description: "Rent receipt", accent: "#0D9488", preview: "clean" },
  },
  voucher: {
    Classic: { name: "Classic", pro: false, description: "Payment voucher", accent: "#0D9488", preview: "clean" },
  },
  packing: {
    Classic: { name: "Classic", pro: false, description: "Packing slip", accent: "#0D9488", preview: "clean" },
  },
  purchase: {
    Classic: { name: "Classic", pro: false, description: "Purchase order", accent: "#0D9488", preview: "clean" },
  },
  proforma: {
    Classic: { name: "Classic", pro: false, description: "Proforma invoice", accent: "#0D9488", preview: "clean" },
  },
};
...
export async function loadTemplate(docType, templateName) {
  ...
  switch (key) {
    ...
    case "internship_Corporate": return (await import("./internship/Corporate")).default;
