...
export default function CertificateTemplate({ form }) {
    ...
    const styles = StyleSheet.create({
        ...
        innerBorder: { flex: 1, border: `1px solid ${T}`, padding: "24 32", alignItems: "center", justifyContent: "center", position: "relative" },
                ...
                <View style={styles.outerWrapper}>
                    <View style={styles.outerBorder}>
                        <View style={styles.innerBorder}>
                            ...
                            <Text style={{ marginTop: 12, fontSize: 8, color: "#D1D5DB" }}>Generated by DocMinty.com</Text>
                        </View>
                    </View>
                </View>
            </Page>
