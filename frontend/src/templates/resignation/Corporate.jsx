...
const REASONS = {
  personal: "I have decided to pursuit a new opportunity that aligns more closely with my personal and professional goals.",
...
export default function ResignationCorporateTemplate({ form }) {
  ...
  const styles = StyleSheet.create({
    ...
    title: { fontSize: 20, fontFamily: "Space Grotesk", fontWeight: 800, color: "#ffffff", marginBottom: 0 },
    metaText: { fontSize: 11, color: "rgba(255,255,255,0.8)", marginTop: 4 },
    ...
    <Document title={`Resignation-Letter-${form.employeeName}`}>
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
            ...
            <Text style={styles.metaText}>{form.employeeName || "Employee Name"} · {form.letterDate}</Text>
        </View>
