...
export default function ProformaClassicTemplate({ form }) {
  ...
  const styles = StyleSheet.create({
    ...
    advBox: { marginTop: 16, backgroundColor: "#FEF9C3", borderWidth: 1, borderColor: "#F59E0B", padding: "12 16", borderRadius: 8, marginBottom: 12 },
    ...
    notesLabel: { fontSize: 8, color: "#9CA3AF", fontWeight: 700, textTransform: "uppercase", marginBottom: 4 },
    ...
    signature: { height: 40, objectFit: "contain", marginBottom: 4, alignSelf: "flex-end" },
        ...
        <View style={styles.body}>
          <View style={styles.billToBox}>
            <View style={styles.billCol}>
              ...
              <Text style={styles.name}>{form.fromName || "Your Business Name"}</Text>
