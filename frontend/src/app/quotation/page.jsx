...
import { Plus, Trash2, Download, Eye, RefreshCw, Cloud, PenTool, Zap } from "lucide-react";
...
export function QuotationPreview({ form, template = "Classic", accent = "#0D9488" }) {
        ...
        <div style={{ background: accent, wordBreak: "break-word" }}>
          <div style={{ padding: "22px 28px 20px", display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
            <div style={{ maxWidth: "55%" }}>
              ...
              <p style={{ fontFamily: "Space Grotesk, sans-serif", fontWeight: 800, fontSize: "17px", color: "#FFFFFF", margin: 0, letterSpacing: "0.01em" }}>{form.fromName || "Your Business Name"}</p>
            ...
            <div style={{ textAlign: "right", flexShrink: 0 }}>
              <p style={{ fontFamily: "Space Grotesk, sans-serif", fontWeight: 900, fontSize: "26px", color: "#fff", margin: 0, letterSpacing: "0.1em" }}>QUOTATION</p>
              <p style={{ fontSize: "11px", color: "rgba(255,255,255,0.75)", margin: "6px 0 0", fontFamily: "Inter, sans-serif" }}>#{form.quoteNumber}</p>
            </div>
          </div>
          <div style={{ background: "#1E293B", padding: "7px 28px", display: "flex", alignItems: "center", flexWrap: "wrap" }}>
            ...
            <span style={{ fontSize: "9px", color: "#fff", fontFamily: "Inter, sans-serif", letterSpacing: "0.05em" }}>DATE: {form.quoteDate}</span>
            {form.validUntil && <><span style={{ color: "rgba(255,255,255,0.3)", margin: "0 12px" }}>|</span><span style={{ fontSize: "9px", color: "#fff", fontFamily: "Inter, sans-serif", letterSpacing: "0.05em" }}>VALID UNTIL: {form.validUntil}</span></>}
          </div>
        </div>
        {sharedBody}
      </div>
      ...
      <div className="pdf-preview">
        ...
        <div style={{ padding: "22px 28px 0", wordBreak: "break-word" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", paddingBottom: "18px" }}>
            ...
            <div style={{ textAlign: "right", flexShrink: 0 }}>
              <p style={{ fontFamily: "Space Grotesk, sans-serif", fontWeight: 900, fontSize: "28px", color: accent, margin: 0, letterSpacing: "0.08em", lineHeight: 1 }}>QUOTATION</p>
              ...
              <div style={{ marginTop: "10px", display: "inline-block", background: "#F8FAFC", border: `1px solid ${accent}30`, borderRadius: "6px", padding: "7px 14px", textAlign: "right" }}>
                <p style={{ fontSize: "9px", fontWeight: 700, color: "#94A3B8", letterSpacing: "0.08em", textTransform: "uppercase", margin: "0 0 2px" }}>QUOTE NUMBER</p>
                <p style={{ fontSize: "13px", fontWeight: 800, color: "#0F172A", fontFamily: "Space Grotesk, sans-serif", margin: 0 }}>#{form.quoteNumber}</p>
                <p style={{ fontSize: "9px", color: "#94A3B8", margin: "3px 0 0", fontFamily: "Inter, sans-serif" }}>Date: {form.quoteDate}</p>
                {form.validUntil && <p style={{ fontSize: "9px", color: accent, margin: "2px 0 0", fontFamily: "Inter, sans-serif", fontWeight: 600 }}>Valid: {form.validUntil}</p>}
              </div>
            </div>
          </div>
                ...
                {(() => {
                  ...
                  return (
                    <div style={{ marginTop: "16px", padding: "12px", background: "#F0F4F3", borderRadius: "8px" }}>
                      {[["Subtotal", `Rs.${calc.subtotal}`], form.taxType === "cgst_sgst" && ["CGST", `Rs.${calc.totalCGST}`], form.taxType === "cgst_sgst" && ["SGST", `Rs.${calc.totalSGST}`], form.taxType === "igst" && ["IGST", `Rs.${calc.totalIGST}`]].filter(Boolean).map(([l, v]) => (
                      ...
                      <div style={{ display: "flex", justifyContent: "space-between", borderTop: "1px solid #D1D5DB", paddingTop: "6px", marginTop: "4px" }}>
                        ...
                        <span style={{ fontSize: "13px", fontWeight: 700, color: T, fontFamily: "Space Grotesk, sans-serif" }}>Rs.{calc.grandTotal}</span>
                      </div>
                    </div>
                  );
                })()}
