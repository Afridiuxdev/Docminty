...
import { UserPlus, Download, X, FileText, Calendar, Mail, Shield, Clock, ChevronRight } from "lucide-react";
...
const DOC_COLORS    = { invoice: T, proforma: "#F59E0B", quotation: "#F59E0B", "salary-slip": "#7C3AED", certificate: "#EC4899", receipt: "#3B82F6", "rent-receipt": "#10B981", "experience-letter": "#6366F1", "purchase-order": "#D97706", "packing-slip": "#4B5563" };
...
function MiniSpinner() {
  return <div style={{ display:"flex",alignItems:"center",justifyContent:"center",padding:"40px" }}><div style={{ width:"28px",height:"28px",border:"2px solid #E5E7EB",borderTopColor:T,borderRadius:"50%",animation:"spin 0.8s linear infinite" }} /><style>{`@keyframes spin{to{transform:rotate(360deg)}}`}</style></div>;
}
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", minWidth: "700px" }}>
              ...
              <tbody>
                {filtered.map((u, i) => {
                  ...
                  return (
                    <tr key={u.id} style={{ borderBottom: "1px solid #F3F4F6", background: i % 2 === 0 ? "#fff" : "#FAFAFA", transition: "background 150ms" }}
                    ...
                    >
                      ...
                      <td style={{ padding: "12px 16px" }}>
                        <div style={{ display:"flex",alignItems:"center",gap:"6px" }}>
                          ...
                          <span style={{ padding: "3px 10px", borderRadius: "12px", fontSize: "11px", fontWeight: 700, background: sc.bg, color: sc.color, fontFamily: "Space Grotesk, sans-serif" }}>{u.status}</span>
                        </div>
                      </td>
                      ...
                      <td style={{ padding: "12px 16px" }}>
                        <div style={{ display:"flex",gap:"6px",alignItems:"center" }}>
                          <button
                            ...
                            style={{ padding: "5px 12px", borderRadius: "6px", border: "1px solid " + T, background: "#F0FDFA", color: T, fontSize: "11px", fontWeight: 600, cursor: "pointer", fontFamily: "Inter, sans-serif", display:"flex",alignItems:"center",gap:"4px" }}
                          >
                            View Profile
                          </button>
                          <button
                            ...
                            style={{ padding: "5px 12px", borderRadius: "6px", border: "1px solid " + (u.status === "BANNED" ? T : "#EF4444"), background: "#fff", color: u.status === "BANNED" ? T : "#EF4444", fontSize: "11px", fontWeight: 600, cursor: "pointer", fontFamily: "Inter, sans-serif", opacity: actioning === u.id ? 0.5 : 1 }}
                          >
