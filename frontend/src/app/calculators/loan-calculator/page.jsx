        ...
        <div style={{ maxWidth: "900px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px", marginBottom: "20px" }} className="calc-grid">
            <div style={{ background: "#fff", border: "1px solid #E5E7EB", borderRadius: "12px", padding: "24px" }}>
              ...
              <div className="form-field"><label className="field-label">Loan Amount (Rs.)</label><input className="doc-input" type="number" value={amount} onChange={e => setAmount(e.target.value)} style={{ height: "44px", fontSize: "16px", fontWeight: 700, color: T, fontFamily: "Space Grotesk, sans-serif" }} /></div>
            ...
            {r ? (
              <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                <div style={{ background: T, borderRadius: "12px", padding: "24px", textAlign: "center" }}>
                  ...
                  <p style={{ fontFamily: "Space Grotesk, sans-serif", fontWeight: 800, fontSize: "40px", color: "#fff", margin: 0 }}>Rs. {fmt(r.emi)}</p>
                </div>
                <div style={{ background: "#fff", border: "1px solid #E5E7EB", borderRadius: "12px", padding: "20px" }}>
                  {[["Principal", `Rs. ${fmt(r.principal)}`, "#111827"], ["Total Interest", `Rs. ${fmt(r.interest)}`, "#EF4444"], ["Total Payment", `Rs. ${fmt(r.total)}`, T], ["Interest Ratio", `${(r.interest / r.total * 100).toFixed(1)}%`, "#7C3AED"]].map(([l, v, c]) => (
