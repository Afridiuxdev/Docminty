...
export default function AdminHeader({ title, subtitle }) {
  ...
  return (
    <header className="admin-page-header" style={{
      ...
      <div className="admin-page-header-actions hide-on-mobile" style={{ display: "flex", alignItems: "center", gap: "12px" }}>
        {/* Search */}
        <div className="admin-search-wrap" style={{ display: "flex", alignItems: "center", gap: "8px", background: "#F8F9FA", border: "1px solid #E5E7EB", borderRadius: "8px", padding: "7px 12px" }}>
