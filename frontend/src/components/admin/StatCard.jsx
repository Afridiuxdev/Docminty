"use client";
export default function StatCard({ title, value, change, up = true, icon, bgColor = "#F0FDFA", prefix = "", suffix = "" }) {
  const T = "#0D9488";
  // Detect if change is a descriptive string or a numeric value
  const isNumeric = typeof change === "number";
  return (
    <div style={{ background: "#fff", border: "1px solid #E5E7EB", borderRadius: "12px", padding: "20px", display: "flex", flexDirection: "column", gap: "10px" }}>
