...
export default function ExperienceMinimalTemplate({ form }) {
    ...
    const styles = StyleSheet.create({
        page: { fontFamily: "Helvetica", fontSize: 10, color: "#111827", padding: "40 50" },
        header: { marginBottom: 30 },
        logo: { width: 45, height: 32, objectFit: "contain", marginBottom: 10 },
        title: { fontSize: 18, fontFamily: "Helvetica-Bold", color: "#111827", marginBottom: 5 },
        dateText: { fontSize: 9, color: "#6B7280" },
        accentBar: { height: 2, backgroundColor: T, width: 40, marginTop: 10, marginBottom: 20 },
        body: { fontSize: 10, color: "#374151", lineHeight: 1.8, marginBottom: 15 },
        signBox: { marginTop: 40 },
        ...
        signDesig: { fontSize: 9, color: "#9CA3AF" },
        footer: { position: "absolute", bottom: 40, left: 50, right: 50, paddingTop: 10, borderTopWidth: 1, borderTopColor: "#F3F4F6" },
        ...
        <Document>
            <Page size="A4" style={styles.page}>
                <View style={styles.header}>
                    ...
                    <Text style={styles.dateText}>{form.letterDate}</Text>
