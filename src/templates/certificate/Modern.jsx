...
const s = StyleSheet.create({
  ...
  top:    { backgroundColor: A, padding: "28 40", alignItems: "center" },
  ...
  badge:  { backgroundColor: "#EEF2FF", borderWidth: 1, borderColor: A, padding: "4 20", borderRadius: 2, marginBottom: 16 },
  badgeT: { fontSize: 10, fontFamily: "Helvetica-Bold", color: A, textTransform: "uppercase", letterSpacing: 2, textAlign: "center" },
  cert:   { fontSize: 11, color: "#6B7280", textAlign: "center", marginBottom: 6 },
  name:   { fontSize: 28, fontFamily: "Helvetica-Bold", color: "#111827", textAlign: "center", borderBottomWidth: 2, borderBottomColor: A, paddingBottom: 8, marginBottom: 10 },
  desc:   { fontSize: 11, color: "#374151", textAlign: "center", lineHeight: 1.6, maxWidth: 340, marginBottom: 8 },
  course: { fontSize: 14, fontFamily: "Helvetica-Bold", color: A, textAlign: "center", marginBottom: 12 },
  ...
  sigL:   { borderTopWidth: 1.5, borderTopColor: "#374151", paddingTop: 5, width: 120, alignItems: "center", marginTop: 18 },
  ...
  bottom: { backgroundColor: A, height: 5, position: "absolute", bottom: 0, left: 0, right: 0 },
});
  ...
  return (
    <Document><Page size="A4" orientation="landscape" style={s.page}>
      ...
      <View style={s.body}>
        ...
        <View style={s.sigs}>
          <View style={s.sigB}><View style={s.sigL}><Text style={s.sigN}>{form.signatoryName || "Signatory"}</Text><Text style={s.sigD}>{form.signatoryDesignation || "Designation"}</Text></View></View>
        </View>
