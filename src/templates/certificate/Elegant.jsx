...
const s = StyleSheet.create({
  ...
  strips: { position: "absolute", top: 0, left: 0, right: 0, height: 10, backgroundColor: A },
  stripsB:{ position: "absolute", bottom: 0, left: 0, right: 0, height: 10, backgroundColor: A },
  sideL:  { position: "absolute", top: 0, left: 0, bottom: 0, width: 10, backgroundColor: A },
  sideR:  { position: "absolute", top: 0, right: 0, bottom: 0, width: 10, backgroundColor: A },
  ...
  badge:  { backgroundColor: A, padding: "4 22", marginBottom: 14 },
