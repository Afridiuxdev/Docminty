...
const s = StyleSheet.create({
  ...
  head:   { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-end", borderBottomWidth: 1, borderBottomColor: "#111827", paddingBottom: 10, marginBottom: 24 },
  ...
  line:   { width: 200, borderBottomWidth: 1, borderBottomColor: "#111827", marginBottom: 12 },
  desc:   { fontSize: 11, color: "#6B7280", textAlign: "center", lineHeight: 1.6, maxWidth: 360, marginBottom: 8 },
  course: { fontSize: 13, fontFamily: "Helvetica-Bold", color: "#111827", textAlign: "center", marginBottom: 16 },
  ...
  sigL:   { borderTopWidth: 1, borderTopColor: "#111827", paddingTop: 5, width: 130, alignItems: "center" },
    ...
    <Document><Page size="A4" orientation="landscape" style={s.page}>
      ...
      <View style={s.body}>
        ...
        <View style={s.meta}>
          ...
          {form.grade && <View style={s.metaI}><Text style={s.metaL}>Grade</Text><Text style={s.metaV}>{form.grade}</Text></View>}
          <View style={s.metaI}><Text style={s.metaL}>Issued On</Text><Text style={s.metaV}>{form.issueDate}</Text></View>
        </View>
