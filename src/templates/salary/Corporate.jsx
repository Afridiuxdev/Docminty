...
export default function SalaryCorporateTemplate({ form }) {
    ...
    const styles = StyleSheet.create({
        ...
        netBox: { backgroundColor: "#0F2340", padding: "16 20", flexDirection: "row", justifyContent: "space-between", alignItems: "center", borderRadius: 8, marginTop: 16 },
