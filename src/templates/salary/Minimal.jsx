...
const s = StyleSheet.create({
  ...
  div:   { borderBottomWidth: 1, borderBottomColor: "#111827", marginBottom: 14, marginTop: 6 },
  ...
  col:   { flex: 1 },
  secL:  { fontSize: 8, fontFamily: "Helvetica-Bold", color: "#111827", textTransform: "uppercase", letterSpacing: 1, borderBottomWidth: 1, borderBottomColor: "#111827", paddingBottom: 3, marginBottom: 4 },
  ...
  gRow:  { flexDirection: "row", justifyContent: "space-between", padding: "4 0", borderTopWidth: 1, borderTopColor: "#111827", marginTop: 2 },
  gL:    { fontSize: 9, fontFamily: "Helvetica-Bold", color: "#111827" },
  netB:  { borderWidth: 1, borderColor: "#111827", padding: "12 16", flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 14 },
  netL:  { fontSize: 8, color: "#9CA3AF", textTransform: "uppercase", letterSpacing: 1, marginBottom: 3 },
  netA:  { fontSize: 20, fontFamily: "Helvetica-Bold", color: "#111827" },
...
export default function SalaryMinimalTemplate({ form }) {
  ...
  var earnings = [["Basic", fmt(form.basic||0)], ["HRA", fmt(form.hra||0)], ["DA", fmt(form.da||0)], ["Conveyance", fmt(form.conveyance||0)], ["Medical", fmt(form.medical||0)]];
  var deductions = [["PF (12%)", fmt(calc.employeePF)], ["Prof. Tax", fmt(calc.professionalTax)], ["TDS", fmt(calc.incomeTax)]];
  var empDetails = [["Employee", form.employeeName||"-"], ["ID", form.employeeId||"-"], ["Designation", form.designation||"-"], ["Department", form.department||"-"], ["PAN", form.panNumber||"-"], ["PF No", form.pfNumber||"-"], ["Pay Date", form.paymentDate||"-"], ["Days", (form.paidDays||"0") + "/" + (form.workingDays||"0")]];
  return (
    <Document>
