...
const styles = StyleSheet.create({
    ...
    totFinal: { flexDirection: "row", justifyContent: "space-between", backgroundColor: "#F0FDFA", padding: "7 10", borderRadius: 3, marginTop: 4 },
...
export default function QuotationClassicTemplate({ form }) {
