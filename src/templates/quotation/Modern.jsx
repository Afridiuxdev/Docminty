...
const s = StyleSheet.create({
  ...
  sidebar: { position: "absolute", left: 0, top: 0, bottom: 0, width: 110, background: A },
  ...
  totF:    { flexDirection: "row", justifyContent: "space-between", backgroundColor: "#EEF2FF", padding: "6 8", borderRadius: 3, marginTop: 4 },
