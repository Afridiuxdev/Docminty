...
const styles = StyleSheet.create({
    ...
    tHeader: { flexDirection: "row", backgroundColor: "#EBF0F7", padding: "5 6", borderBottomWidth: 1, borderBottomColor: "#E5E7EB" },
    ...
    totFinal: { flexDirection: "row", justifyContent: "space-between", backgroundColor: "#EFF6FF", padding: "7 10", borderRadius: 3, marginTop: 4 },
...
export default function QuotationCorporateTemplate({ form }) {
