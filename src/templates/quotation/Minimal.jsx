...
const styles = StyleSheet.create({
    ...
    tHeader: { flexDirection: "row", backgroundColor: "#F3F4F6", padding: "5 6", borderBottomWidth: 1, borderBottomColor: "#E5E7EB" },
    ...
    totFinal: { flexDirection: "row", justifyContent: "space-between", backgroundColor: "#F8F9FA", padding: "7 10", borderRadius: 3, marginTop: 4 },
...
export default function QuotationMinimalTemplate({ form }) {
