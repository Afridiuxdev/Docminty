...
export default function InvoiceMinimalTemplate({ form }) {
    ...
    const styles = StyleSheet.create({
        ...
        invoiceL: { fontSize: 22, fontFamily: "Helvetica-Bold", color: T, textAlign: "right" },
        num: { fontSize: 9, color: "#9CA3AF", textAlign: "right", marginTop: 3 },
        divider: { borderBottomWidth: 1, borderBottomColor: T, marginBottom: 16 },
        ...
        tHeader: { flexDirection: "row", borderBottomWidth: 1, borderBottomColor: T, padding: "4 0", marginBottom: 2 },
        tRow: { flexDirection: "row", padding: "5 0", borderBottomWidth: 1, borderBottomColor: "#F3F4F6" },
        thT: { fontSize: 8, fontFamily: "Helvetica-Bold", color: T, textTransform: "uppercase", letterSpacing: 0.5 },
        ...
        totFinal: { flexDirection: "row", justifyContent: "space-between", borderTopWidth: 1, borderTopColor: T, paddingTop: 6, marginTop: 4 },
        totFT: { fontSize: 11, fontFamily: "Helvetica-Bold", color: T },
