...
export default function AdminHeader({ title, subtitle }) {
  return (
    <header style={{ background: "#fff", borderBottom: "1px solid #E5E7EB", padding: "0 28px", height: "64px", display: "flex", alignItems: "center", justifyContent: "space-between", position: "sticky", top: 0, zIndex: 10 }}>
      <div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
        ...
        <div style={{ position: "relative", cursor: "pointer", width: "36px", height: "36px", background: "#F8F9FA", border: "1px solid #E5E7EB", borderRadius: "8px", display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        <div style={{ width: "36px", height: "36px", background: T, borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "13px", fontWeight: 700, color: "#fff", cursor: "pointer", fontFamily: "Space Grotesk, sans-serif" }}>A</div>
      </div>
    </header>
  );
}
