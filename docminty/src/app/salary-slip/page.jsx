      ...
      {(form.bankName || form.accountNumber) && (
        <div style={{ marginTop: "16px", padding: "12px 16px", background: "#F8F9FA", borderRadius: "6px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "12px" }}>
            {[["Bank", form.bankName], ["Account", form.accountNumber ? "X".repeat(Math.max(0, form.accountNumber.length - 4)) + form.accountNumber.slice(-4) : form.accountNumber], ["IFSC", form.ifscCode]].map(([l, v]) => v && (
              <div key={l}>
