...
export default function InvoiceBoldTemplate({ form }) {
    const A = form.templateColor || "#EF4444";
    ...
    const styles = StyleSheet.create({
        ...
        topBar: { backgroundColor: A, padding: "22 36", flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
        ...
        tHeader: { flexDirection: "row", backgroundColor: A + "10", padding: "5 6", borderLeftWidth: 3, borderLeftColor: A },
