...
export default function ElegantTemplate({ form }) {
    ...
    const styles = StyleSheet.create({
        ...
        header: { borderBottomWidth: 4, borderBottomColor: T, padding: "20 24 16", flexDirection: "row", justifyContent: "space-between", alignItems: "flex-end" },
        logo: { height: 40, objectFit: "contain", marginBottom: 8 },
        companyName: { fontFamily: "Space Grotesk", fontWeight: 700, fontSize: 16, color: "#111827" },
        ...
        period: { fontSize: 12, color: "#6B7280", marginTop: 4 },
        ...
        bankSection: { marginTop: 16, padding: "12 16", back: "#F8F9FA", borderRadius: 6 },
        ...
        mgrName: { fontSize: 10, fontWeight: 700, borderTopWidth: 1, borderTopColor: "#374151", paddingTop: 4 },
        mgrLabel: { fontSize: 8, color: "#9CA3AF", marginTop: 2 }
    });
