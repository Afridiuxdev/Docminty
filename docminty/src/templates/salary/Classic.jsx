...
export default function SalaryTemplate({ form }) {
    ...
    const styles = StyleSheet.create({
        ...
        header: { backgroundColor: T, padding: "20 24", flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start" },
        logo: { height: 40, objectFit: "contain", marginBottom: 8 },
        companyName: { fontFamily: "Space Grotesk", fontWeight: 700, fontSize: 16, color: "#ffffff" },
        companyDetails: { fontSize: 11, color: "rgba(255,255,255,0.8)", marginTop: 2 },
        titleBox: { textAlign: "right" },
        title: { fontFamily: "Space Grotesk", fontWeight: 800, fontSize: 18, color: "#ffffff" },
        period: { fontSize: 12, color: "rgba(255,255,255,0.8)", marginTop: 4 },
        ...
        tableBox: { flex: 1 },
        tableTitle: { fontSize: 11, fontWeight: 700, color: "#ffffff", padding: "6 12", borderRadius: "4 4 0 0" },
        ...
        bankSection: { marginTop: 16, padding: "12 16", backgroundColor: "#F8F9FA", borderRadius: 6 },
        bankGrid: { flexDirection: "row", gap: 24 },
        
        footer: { marginTop: 40, paddingTop: 12, borderTopWidth: 1, borderTopColor: "#E5E7EB", flexDirection: "row", justifyContent: "space-between", alignItems: "flex-end" },
    ...
    return (
        <Document title={`SalarySlip-${form.employeeName}-${form.month}`}>
            <Page size="A4" style={styles.page}>
                <View style={styles.header}>
                    <View>
                        ...
                        {companyState && <Text style={styles.companyDetails}>{companyState.name}</Text>}
                    </View>
                ...
                <View style={styles.main}>
                    ...
                    <View style={styles.splitSection}>
                        <View style={styles.tableBox}>
                            ...
                            <View style={styles.table}>
                                ...
                                <View style={[styles.tr, { backgroundColor: "#F0F9F8", borderBottomWidth: 0 }]}>
                                    <Text style={{ fontWeight: 700, color: T }}>Gross Salary</Text>
                                    <Text style={{ fontWeight: 700, color: T }}>Rs.{parseFloat(calc.grossSalary).toLocaleString("en-IN")}</Text>
                                </View>
                            </View>
                        </View>
                        <View style={styles.tableBox}>
                            ...
                            <View style={styles.table}>
                                ...
                                <View style={[styles.tr, { backgroundColor: "#FEF2F2", borderBottomWidth: 0 }]}>
                                    <Text style={{ fontWeight: 700, color: "#EF4444" }}>Total Deductions</Text>
                                    <Text style={{ fontWeight: 700, color: "#EF4444" }}>Rs.{parseFloat(calc.totalDeductions).toLocaleString("en-IN")}</Text>
                                </View>
                            </View>
                        </View>
                    </View>
                    ...
                    <View style={styles.netPayBox}>
                        <View>
                            ...
                            <Text style={styles.netPayAmount}>Rs.{parseFloat(calc.netSalary).toLocaleString("en-IN")}</Text>
                        </View>
                        <View>
                            <Text style={[styles.netPayLabel, { textAlign: "right" }]}>In Words</Text>
                            <Text style={styles.inWords}>{numberToWords(Math.floor(parseFloat(calc.netSalary)))} Only</Text>
                        </View>
                    </View>
                    ...
                    <View style={styles.footer} fixed>
                        ...
                        <View style={styles.signatureBox}>
                            ...
                            <View style={styles.signatureLine}>
                                ...
                                <Text style={[styles.label, { fontSize: 8 }]}>Authorized Signatory</Text>
                            </View>
                        </View>
                    </View>
                </View>
